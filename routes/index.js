...
router.post('/add', function(req, res, next) {
  ...
  var n = {
    ...
    stockticker: req.body.symbol,
    numstocks: req.body.volume,
    algorithm: req.body.algorithm,
    params: "" +  tmp_param1 + ", " + tmp_param2 + ", " + req.body.radio + ", " + tmp_time_interval,
    enabled: 1,
    signal: function(){}
  }

  client.query("INSERT INTO userstocks (email, stockticker, numstocks, algorithm, params, enabled) VALUES ('" + n.email + 
    "','" + n.stockticker + "','" + n.numstocks + "','" + n.algorithm + "','" + n.params + "','" + n.enabled + "')")
